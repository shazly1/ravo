    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <a href="https://whatsapp.com/channel/0029VbDGUstJZg4GfkvZlY1f" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 card p-4 hover:border-green-500/50 hover:bg-green-500/5 transition-all group">
            <div className="w-12 h-12 rounded-xl bg-green-500/10 flex items-center justify-center text-2xl group-hover:bg-green-500/20 transition-colors">📱</div>
            <div>
          ...
          <a href="https://www.instagram.com/ravo_affiliate" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 card p-4 hover:border-pink-500/50 hover:bg-pink-500/5 transition-all group">
            <div className="w-12 h-12 rounded-xl bg-pink-500/10 flex items-center justify-center text-2xl group-hover:bg-pink-500/20 transition-colors">📸</div>
            <div>
          ...
          <a href="https://www.tiktok.com/@ravoaffiliate" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 card p-4 hover:border-white/20 hover:bg-white/5 transition-all group">
            <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-2xl group-hover:bg-white/10 transition-colors">🎵</div>
            <div>
          ...
          <a href="https://www.facebook.com/groups/961520243275695" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 card p-4 hover:border-blue-500/50 hover:bg-blue-500/5 transition-all group">
            <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center text-2xl group-hover:bg-blue-500/20 transition-colors">👥</div>
            <div>
